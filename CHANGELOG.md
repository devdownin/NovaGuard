...
- Tests du verrou de démarrage (`__tests__/monitoringGuard.test.tsx`) : refus sans permission caméra, demande de la permission, démarrage une fois accordée. **139 tests au total.**
