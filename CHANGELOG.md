...
- Tests de la phase de démarrage (`__tests__/monitoringGuard.test.tsx`) : refus sans permission caméra, enchaînement après acceptation, refus conservé après un non, et surtout le réarmement différé qui empêche un démarrage raté de se rejouer au lancement suivant. **144 tests au total.**
