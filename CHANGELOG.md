...
- Tests du nommage et du renommage des clips (`__tests__/videoStore.test.ts` et `library.test.ts`) : tri chronologique, caractères sûrs, refus d'écrasement, repli sur le nom d'origine si le déplacement échoue. **136 tests au total.**
